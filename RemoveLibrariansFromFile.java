...
public class RemoveLibrariansFromFile{
    public static void removeLibrarianFromFile(String filename, String LibrarianToRemove) {
        ...
        try {
            ...
            while ((currentLine = br.readLine()) != null) {
                if (!currentLine.contains(LibrarianToRemove)) {
