...
public class BooksManageReaders implements EventHandler<ActionEvent> {
    private Stage primaryStage;
    private Books book;
    public BooksManageReaders(Stage primaryStage,Books book) {
    ...
    public void handle(ActionEvent event){
        ...
        order.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                alert.setHeaderText(null);
                alert.setContentText("Book has been ordered successfully!");
                alert.showAndWait();
                new ManageBooks(primaryStage).handle(event);
            }
        });
        ...
        VBox vbox = new VBox(header,grid, rent, order, back);
        vbox.setSpacing(20);
